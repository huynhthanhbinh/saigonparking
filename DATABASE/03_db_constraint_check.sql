...
GO
ALTER TABLE [PARKING_LOT]
    WITH CHECK ADD CONSTRAINT [CK_PARKING_LOT_VALID_AVAILABILITY] CHECK (([AVAILABILITY] >= (0) AND [AVAILABILITY] <= [CAPACITY]))
GO
ALTER TABLE [PARKING_LOT]
    CHECK CONSTRAINT [CK_PARKING_LOT_VALID_AVAILABILITY]
GO
ALTER TABLE [PARKING_LOT]
