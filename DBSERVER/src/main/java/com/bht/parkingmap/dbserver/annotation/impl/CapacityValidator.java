 ...
 * @author bht
 */
public final class CapacityValidator implements ConstraintValidator<CapacityValidation, ParkingLotInformationEntity> {

    @Override
    public boolean isValid(ParkingLotInformationEntity parkingLotInformationEntity, ConstraintValidatorContext constraintValidatorContext) {
