...
public abstract class EnumMapper implements BaseBean {
    ...
    private static final BiMap<Long, UserRole> USER_ROLE_MAP = HashBiMap.create(5);
    private static final BiMap<Long, ParkingLotType> PARKING_LOT_TYPE_MAP = HashBiMap.create(4);
    ...
    @Named("toUserRoleId")
    public Long toUserRoleId(UserRole userRole) {
    ...
    public Long toParkingLotTypeId(ParkingLotType parkingLotType) {
    ...
    private void initUserRoleMap() {
        ...
        USER_ROLE_MAP.put(4L, UserRole.GOVERNMENT_EMPLOYEE);
    }
